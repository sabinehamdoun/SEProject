...
<body>
    ...
    <div class="all-title-box" style="background-image: url(./images/featured-image-types-of-paint.jpeg.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2>Registering Painting Walls</h2>
                    <ul class="breadcrumb">
    ...
    <div class="box-add-products">
        ...
        <form action="registrating_painting.php" method="POST"> 
            <fieldset class="form1regestration">
                ...
                rooms: <input type="text" name="quantity" style="border:0.1px solid black;  border-radius:5px; padding:10px;"placeholder="Enter your number of rooms" required class="input">
                <br>
                color: <input type="text" name="color" placeholder="Enter your color" style="border:0.1px solid black;  border-radius:5px; padding:10px;"required class="input">
