                    ...
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
								...
								<li><a href="registrationpanting(html).php">Painting walls</a></li>
                ...
                <div class="col-xl-5 col-lg-5 col-md-6">
                    <div id="carousel-example-1" class="single-product-slider carousel slide" data-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active"> <img class="d-block w-100" src="images/1A.png"
                                    alt="First slide"> </div>
                        </div>
                    ...
                    <div class="single-product-details">
                        ...
                        <div class="price-box-bar">
                            <div class="cart-and-bay-btn">
                                <a href="Addtocart.php?productId=1" class=" btn hvr-hover" data-fancybox-close="" onclick="Added()" href="Addtocart.php"><i class="fas fa-shopping-cart"></i>  Add to Cart</a>
                        ...
                        <div class="share-bar">
                            ...
                            <a class="btn hvr-hover" href="https://www.twitter.com/"><i class="fab fa-twitter"
                                    aria-hidden="true"></i></a>
