            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Product 5 </li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="col-xl-5 col-lg-5 col-md-6">
                    <div id="carousel-example-1" class="single-product-slider carousel slide" data-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active"> <img class="d-block w-100" src="images/5E.png"
                                    alt="First slide"> </div>
                        </div>
                ...
                <div class="col-xl-7 col-lg-7 col-md-6">
                    <div class="single-product-details">
                        ...
                        <div class="price-box-bar">
                            ...
                            <a href="Addtocart.php?productId=5" class=" btn hvr-hover" data-fancybox-close="" onclick="Added()" href="Addtocart.php"><i class="fas fa-shopping-cart"></i>  Add to Cart</a>
                            </div>
                        </div>
